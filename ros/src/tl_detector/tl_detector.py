...
class TLDetector(object):
    """Class to handle traffic light detection."""

    def __init__(self):
        """Build TLDetector object."""
    ...
    def image_cb(self, msg):
        """Identify red lights in the incoming camera image.
    ...
    def get_closest_waypoint(self, x, y):
        """Identify the closest path waypoint to the given position.
    ...
    def get_light_state(self, light):
        """Determine the current color of the traffic light.
    ...
    def process_traffic_lights(self):
        ...
        Determine also its location and color.

        Returns
        -------
            int: index of waypoint closes to the upcoming stop line
        ...
        if(self.pose):
            ...
            threshold = len(self.waypoints.waypoints)
            for i, light in enumerate(self.lights):
                line = stop_line_positions[i]
                temp_wp_idx = self.get_closest_waypoint(line[0], line[1])
                # Only consider lights ahead of car
